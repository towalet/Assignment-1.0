...
def game1role1():
    ...
    if role1.health>role2.health:
        print(role1.name,"has won the first challenge! Congratulations !!!")
    elif role1.health<role2.health:
        print(role2.name,"has won! You have lost the first challenge! ")
...
def game2role2():
    ...
    while tries>0:
        ...
        dice3=random.randint(1,6)
        dice4=random.randint(1,6)
        dicetotal=dice1+dice2+dicetotal+role2.strength
        dicetotal2=dice3+dice4+dicetotal2+role1.strength
        print()
    ...
    if 6<=dicetotal<16:
        print("Critical Loss! ")
        role2.health=role2.health-5
        print("Due to the critical loss, you lost 5 HP. \nYour current health is:",role2.health,"HP")
    elif 16<=dicetotal<26:
        print("Loss! ")
        role2.health=role2.health-3
        print("Due to the loss, you lost 3 HP. \nYour current health is: ",role2.health)
    elif 24<=dicetotal<33:
        print("Win !")
        print("Congratulations! You won in the second challenge! ")
    elif 33<=dicetotal:
        print("Critical Win !!!")
        print("Congratulations! You won in the second challenge! ")
    elif dicetotal2==dicetotal:
